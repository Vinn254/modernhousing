...
export async function POST(request) {
    try {
        ...
        const transactionDate = body.CallbackMetadata?.Item?.find((i) => i.Name === 'TransactionDate')?.Value ?? '';
        const transactionId = body.CallbackMetadata?.Item?.find((i) => i.Name === 'TransactionId')?.Value ?? '';
        if (!tenantId) {
