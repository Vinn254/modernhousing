        ...
        <div className="bento">
          <article className="card" style={{ gridColumn: 'span 12' }}>
            ...
            <DonutChart 
              ...
              centerLabel={String(units.filter(u => u.occupancy_status === 'occupied').length) + '/' + String(units.length)} 
            />
            <p style={{ color: 'var(--ink-3)', marginTop: 8, fontSize: '13px' }}>Occupied / Total Units</p>
          </article>
