    ...
    <>
      <section className="hero">
        ...
        <div className="hero-inner">
          <span className="eyebrow"><span className="pulse"></span> Super Admin Portal</span>
          <h1>Super Admin Dashboard</h1>
          <p className="hero-sub">Manage administrators, agents, properties, tenants, and payments across every landlord workspace.</p>
        </div>
      </section>
