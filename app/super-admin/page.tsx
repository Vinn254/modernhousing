      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-sub">
            Manage all administrators, agents, properties, and tenants across the platform.
          </p>
        </div>
      </section>
      ...
      <section className="bento-section">
        <div className="bento">
          ...
          <article className="card card-pm">
            ...
            <h3>Manage all administrator accounts.</h3>
            <p>Create, edit, and remove administrators. Control user lifecycle and permissions.</p>

            <Link href="/super-admin/admins" className="card-cta">
              Manage Admins
          ...
          <article className="card card-agent">
            ...
            <Link href="/super-admin/agents" className="card-cta">
              View Agents
              <svg className="arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </Link>
          </article>
          ...
          <article className="card card-feat card-feat-1">
            <div className="feat-icon" style={{backgroundColor:'var(--accent-bright)'}}>
            ...
            <Link href="/super-admin/properties" className="card-cta">
              View Properties
              <svg className="arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </Link>
          </article>
          ...
          <article className="card card-feat card-feat-3">
            <div className="feat-icon" style={{backgroundColor:'var(--navy-600)'}}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
            </div>
            <h3>Payments</h3>
            <p>Review all payment transactions, admin subscriptions, and financial analytics.</p>
            <Link href="/super-admin/payments" className="card-cta accent">
              View Payments
              <svg className="arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </Link>
          </article>
