    ...
    <div className="pricing-hero-inner">
      ...
      <section className="pricing-section">
        <div className="pricing-grid">
          {plans.map((plan) => (<article className={`pricing-card ${plan.popular ? 'popular' : ''}`} key={plan.name}>
              ...
              <ul>
                {plan.features.map((feature) => (<li key={feature}>
...
export default function PricingPage() {
    return (<Suspense fallback={<div style={{ padding: '40px', display: 'flex', justifyContent: 'center' }}>Loading…</div>}>
      <PricingContent />
    </Suspense>);
}
