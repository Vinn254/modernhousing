    ...
    <>
      <section className="hero">
        ...
        <div className="hero-inner">
          <span className="eyebrow"><span className="pulse"></span> Apartment management platform</span>
      ...
      <section className="bento-section">
        <div className="bento">
          ...
          <article className="card card-agent">
            ...
            <p>Agents see only the property assigned by the landlord and can add tenants, send notices, and review complaints.</p>
          ...
          <article className="card card-feat card-feat-2">
            ...
            <h3>Secure Roles</h3>
            <p>Role-based routing keeps landlord pages hidden from tenants and limits agents to their assigned property.</p>
          </article>
