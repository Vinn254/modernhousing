...
export default function PaymentsPage() {
  ...
  return (
    <main className="container">
      ...
      <article className="bento-card" style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 8, position: 'relative', background: '#0D1F2D' }} onMouseLeave={() => setHoverMonth(null)}>
        ...
        <div style={{ display: 'flex', gap: '4px', marginTop: 8, height: 28 }}>
