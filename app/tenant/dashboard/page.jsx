...
function StatIcon({ path, bg }) {
    return (<span className="stat-icon" style={{ background: bg }}>
...
export default function TenantDashboardPage() {
    ...
    async function handlePictureUpload(event) {
        ...
        if (response.ok) {
            setData((prev) => prev ? {
                ...prev,
                tenant: { ...prev.tenant, picture_url: result.pictureUrl ?? prev.tenant.picture_url }
            } : prev);
    ...
    <section className="kpi-row">
          <div className="kpi-tile">
            <img src={tenant.picture_url || '/placeholder-avatar.png'} alt="Profile" className="avatar-ring" style={{ width: 46, height: 46, flexShrink: 0 }} key={tenant.picture_url || 'placeholder'}/>
