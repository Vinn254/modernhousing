...
export default function PropertiesPage() {
    ...
    return (<>
      ...
      {showModal && selectedProperty && (<div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && setShowModal(false)}>
          <div className="modal-card landlord-modal property-modal">
            ...
            <div className="property-unit-list" style={{ marginTop: '20px' }}>
              ...
              {units.length === 0 ? (<div className="landlord-empty">No units recorded for this property.</div>) : (<table className="landlord-table" style={{ marginTop: '10px' }}>
                  <thead>
                    <tr>
                      <th>Unit</th>
                      <th>Rent</th>
                  ...
                  <tbody>
                    {filteredUnits.map((unit) => (<tr key={unit.id}>
