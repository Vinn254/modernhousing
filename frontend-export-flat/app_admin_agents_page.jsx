...
export default function AgentsPage() {
    ...
    async function loadData() {
        ...
        try {
            ...
            if (!agentsResponse.ok)
                throw new Error(agentsResult.message ?? 'Failed to load agents');
            if (!propertiesResponse.ok)
                throw new Error(propertiesResult.message ?? 'Failed to load properties');
    ...
    async function handleRemove(agentId) {
        if (!confirm('Remove this agent from active property access?'))
            return;
    ...
    <section className="card-grid">
          ...
          <div className="card">
            ...
            {!loading && agents.length > 0 && (<div className="table-shell">
