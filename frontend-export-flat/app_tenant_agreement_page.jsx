...
export default function TenantDocumentsPage() {
    ...
    async function handleUploadSignedDocs(event) {
    ...
    return (<main className="container page-layout" style={{ maxWidth: '100%', padding: '0 8px' }}>
      ...
      {loading ? <p>Loading documents…</p> : (<>
          {agreementDocs.length > 0 && (<section style={{ marginTop: 24 }}>
          ...
          {agreementDocs.length === 0 && (<section className="card" style={{ marginTop: 24 }}>
          ...
          <section className="card" style={{ marginTop: 24, overflowX: 'auto' }}>
            ...
            {signedAgreementDocs.length === 0 && idDocs.length === 0 && kinIdDocs.length === 0 ? (<p>No documents submitted yet.</p>) : (<div className="table-shell" style={{ overflowX: 'auto' }}>
                <table className="landlord-table" style={{ minWidth: '300px', fontSize: '12px' }}>
                  ...
                  <tbody>
                    ...
                    {idDocs.map((doc, i) => (<tr key={doc.id}>
                    ...
                    {kinIdDocs.map(doc => (<tr key={doc.id}>
